...
"""
To make this easier for you we've provided you a logging function, which you just need to import and call in one place. 
It takes a snapshot of your game state about once per second, for up to 16 seconds or until the game exits
"""
